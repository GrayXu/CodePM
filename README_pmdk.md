...
## Contents
- [**PMDK: Persistent Memory Development Kit**](#pmdk-persistent-memory-development-kit)
  - [Contents](#contents)
  - [Libraries and Utilities](#libraries-and-utilities)
  - [Getting Started](#getting-started)
  - [Version Conventions](#version-conventions)
  - [Pre-Built Packages for Windows](#pre-built-packages-for-windows)
  - [Dependencies](#dependencies)
    - [Linux](#linux)
    - [Windows](#windows)
    - [FreeBSD](#freebsd)
  - [Building PMDK on Linux or FreeBSD](#building-pmdk-on-linux-or-freebsd)
    - [Make Options](#make-options)
    - [Testing Libraries on Linux and FreeBSD](#testing-libraries-on-linux-and-freebsd)
    - [Memory Management Tools](#memory-management-tools)
  - [Building PMDK on Windows](#building-pmdk-on-windows)
    - [Testing Libraries on Windows](#testing-libraries-on-windows)
  - [Experimental Packages](#experimental-packages)
    - [The librpmem and rpmemd packages](#the-librpmem-and-rpmemd-packages)
